...
<p className="text-xs text-gray-400 mt-1">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam et quidem praesentium consectetur beatae nobis</p>
    </div>
